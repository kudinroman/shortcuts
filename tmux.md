...
| C-f S-Up    | Move the visible part of the window up                     |
| C-f S-Down  | Move the visible part of the window down                   |
| C-f S-Left  | Move the visible part of the window left                   |
| C-f S-Right | Move the visible part of the window right                  |
